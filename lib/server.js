...
function Server(options) {
  ...
  options = options || {path: '/sse', fallback: true, keepalive: 1000, authenticationResolver: null, needsAuth: false}
  options = typeof options === 'string' ? {path: options, fallback: true, keepalive: 1000, authenticationResolver:null, needsAuth: false} : options
...
proto.install = function(server) {
  ...
  function is_okay(req) {
    var is_okay = req.method === 'GET' // jshint ignore:line
